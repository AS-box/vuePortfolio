<template>
  <ValidationObserver v-slot="ObserverProps">
    <v-form v-model="valid" data-netlify-recaptcha="true" data-netlify-honeypot="bot-field" data-netlify="true" ref="form" method="POST" class="mt-4" action="/contact/thanks/">
